    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < n; i++) {
        	...
        	scanner.nextLine(); // Avoiding the \n problem in console
        	 ...
        	 /*Looping through the paid characters and storing inside arrays to check 
        	 * how much will pay to the current article */  
        	for (int j = 0; j < k; j++) {
        	...
        	scanner.nextLine(); // Avoiding the \n problem in console
        	 ...
        	 /* Looping through the article and calculate how much money publisher must
        	 * pay for the article */ 
        	for (int l = 0; l < m; l++) {
